...
# module references:
# $rocket_module_name, mem_reset_control, ethernet, sdc_controller, uart, ethernet_pa200t_starlite
...
proc write_mig_file_riscv_mig_7series_0_0 { str_mig_prj_filepath } {
   ...
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="" PADName="W5" SLEW="" VCCAUX_IO="" name="ddr3_addr[14]"/>}
...
proc create_hier_cell_IO { parentCell nameHier } {
  ...
  set block_name ethernet_pa200t_starlite
